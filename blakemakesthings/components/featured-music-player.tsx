    ...
    <div className="space-y-8">
      ...
      <div className="relative rounded-xl border border-purple-500/20 bg-zinc-900/70 p-6 backdrop-blur-sm">
        <div className="grid gap-6 md:grid-cols-[300px_1fr]">
          {/* Album Art */}
          <div className="relative aspect-square overflow-hidden rounded-lg border border-zinc-800" style={{ position: 'relative' }}>
            <Image
      ...
      <ScrollArea className="w-full pb-4">
        <div className="flex space-x-4 pb-4">
          {featuredTracks.map((track, index) => (
            ...
            >
              <div className="relative aspect-square overflow-hidden rounded-md" style={{ position: 'relative' }}>
                <Image
