...
export default function ChatInterface({ user, initialConversationId }: ChatInterfaceProps) {
  ...
  // Get conversation title if ID is provided
    ...
    <>
      ...
      >
        <div className="flex flex-col h-full">
          ...
          <div className="flex-1 overflow-y-auto p-4">{/* ConversationList component would go here */}</div>
          ...
          {messages.length === 0 ? (
            ...
            <div className="space-y-6">
              {messages.map((message) => (
                ...
                >
                  <div
                    className={`w-8 h-8 rounded-full flex items-center justify-center text-foreground shrink-0 ${
                  ...
                  <div className="flex-1 overflow-hidden">
                    <div className="prose prose-invert prose-sm sm:prose-base max-w-none">{message.content}</div>
                  </div>
                </div>
              ))}
            </div>
